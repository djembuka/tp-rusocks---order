		...
		<div id="bx-soa-order" class="row bx-<?= $arParams['TEMPLATE_THEME'] ?>" style="opacity: 0">
			...
			<div class="col-sm-9 bx-soa">
				...
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container row">
						<h2 class="bx-soa-section-title col-sm-9">
							<span class="bx-soa-section-title-count"></span><?= $arParams['MESS_REGION_BLOCK_NAME'] ?><span id="bx-soa-region-name"></span>
						</h2>
				...
				<div id="bx-soa-orderSave">
					<? //$getMinOrder = TwpxClasses::MinOrderSumm(); ?>
					<? if (intval($arResult['ORDER_TOTAL_PRICE']) < $getMinOrder['MIN_ORDER'] && false) : ?>
						<div class="minimal_summ text-center">
							Минимальная сумма заказа <?= number_format($getMinOrder['MIN_ORDER'], 0, '.', ' ') ?> ₽
						</div>
					<? else : ?>
						<div class="checkbox">
							<?
