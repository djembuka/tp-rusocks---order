...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
      ...
      document.getElementById('bx-soa-region-name').textContent = `: ${BX.Sale.OrderAjaxComponent.getLocationString(document.querySelector('.bx-soa-location-input-container'))}`;
						...
						label = BX.create('LABEL', {
							children: [
								BX.create('INPUT', {
									...
									props: {type: 'radio', name: 'PERSON_TYPE', value: currentType.ID, className: 'with-gap'}
								}),
                BX.create('SPAN', {html: currentType.NAME})
							],
							events: {change: BX.proxy(this.sendRequest, this)}
						});
      ...
      if (propertyType !== 'STRING') {
		...
		editPropsComment: function(propsNode)
		{
			...
			propsCommentContainer = BX.create('DIV', {props: {className: 'bx-soa-customer-comment'}});
			label = BX.create('LABEL', {
